...
docker compose -f ${APREXIS_DOCKER_COMPOSE_FILE} run --rm engine bundle exec rails db:drop
docker compose -f ${APREXIS_DOCKER_COMPOSE_FILE} run --rm engine bundle exec rails db:create
